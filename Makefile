...
CMPL_SRCS	= Suit.cpp Game.cpp PinochleDeck.cpp PinochleGame.cpp HoldEmDeck.cpp HoldEmGame.cpp lab1.cpp

#               Source files containing only template class method definitions
TMPL_SRCS	= CardSet_T.cpp Deck_T.cpp Card_T.cpp

#               Header (.h) files
HEADER_FILES    = GlobalValues.h Suit.h CardSet_T.h Card_T.h Deck_T.h Game.h PinochleDeck.h PinochleGame.h HoldEmDeck.h HoldEmGame.h
